...
def main():
    parser = argparse.ArgumentParser(description="Train XGBoost for unstable_15 prediction")
    ...
    preds_path = outdir / "xgb_test_predictions.csv"
    preds_df.to_csv(preds_path, index=False)

    sweep_df = compute_threshold_metrics(preds_df, prob_col="y_prob", y_col="y_true")
    sweep_path = outdir / "xgb_threshold_sweep.csv"
    ...
    try:
        ...
        imp_path = outdir / "xgb_feature_importance.csv"
